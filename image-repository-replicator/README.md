...
| ----------- | ----------- | ------------- |
| SOURCE_REPOSITORY_URL | The source container image repository for the replication | `ghcr.io/dBildungsplattform/schulcloud-server` |
...
| DEST_REPOSITORY_URL | The destination container image repository for the replication | `ghcr.io/dBildungsplattform/schulcloud-server` |
